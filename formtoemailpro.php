...
$my_email = "chuckmrandall@gmail.com, cmrandall@yahoo.com";
...
$from_email = "chuck@cmrandall.com";
...
$thank_you_message_template_filename = "";
...
$blocked_words = array('http://','https://','viagra', 'sex', 'porn');
...
$autoresponder_from = "autoresponder@cmrandall.com";
...
$autoresponder_subject = "Your Website Inquiry from cmrandall.com";
...
$autoresponder_header_message = "Thank you for your inquiry.  We will get back to you shortly.  The data you submitted is shown below.";
...
$autoresponse_email_template_filename = "formautoresponder.php";
...
foreach($required_fields as $value){if((!isset($_REQUEST[$value]) || (empty($_REQUEST[$value]) && $_REQUEST[$value] != "0")) && (!isset($_FILES[$value]['name']) || empty($_FILES[$value]['name']))){$errors[] = "$value field";}}
